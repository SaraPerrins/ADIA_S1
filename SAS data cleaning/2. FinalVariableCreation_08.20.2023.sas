...
*weight w_0;
tables black white hisp asian_nhpi othrace/missing;
run; 
...
sensitivityNOTRES;
run;
proc sort data=finalvar_08202023;
by childid;
run;
...
by childid;
run;
data nls.finalvar_08202023;
   MERGE adjinco_f3 finalvar_08202023;
   BY childid;
  PROC PRINT DATA=nls.finalvar_08202023 (obs=50); 
  RUN;
proc contents data=nls.finalvar_08202023;
run;

  proc export data=nls.finalvar_08202023
    outfile='C:/Users/55484/OneDrive - ICF/Documents/ADIA/Data/finalvar_08202023.csv'
    dbms=csv
	replace;
	putnames=yes;
run;
...
proc freq data=nls.finalvar_08202023;
*weight w_0;
tables ygender_xrnd
biryear_xrnd
black 
...
proc univariate data=nls.finalvar_08202023;
var drinkdy depress
preshlth
anxiety
mhhinco;
...
proc corr data=nls.finalvar_08202023 alpha nomiss;
var var1 var2 var3;
run;
