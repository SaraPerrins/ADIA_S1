...
intage=INT(YRDIF(dob, mdy(1,1,2018), "AGE"));
...
run;
proc means data=one n sum mean stddev;
var w w_0;
run;
...
var intage;
run;
proc means data=one n mean std vardef=weight; 
weight w_0; var intage;
run;
proc means data=one mean stddev;
*weight w_0;
var intage;
...
proc freq data= one;
	tables mentill mentill_2012 mentill_2014 mentill_2016 mentill_2018;
run;
...
*checking that frequency of combined variable matched individual years;
proc freq data= two;
	tables subsuse subsuse_2012 subsuse_2014 subsuse_2016 subsuse_2018;
run;
...
proc freq data=three;
	tables physabu physabu_2012 physabu_2014 physabu_2016 physabu_2018;
run;
...
run;
proc freq data=four;
tables divorce divorce_sum divorce_1979-divorce_2000;
run;
...
run;
proc freq data=five;
tables incarce incarce_2006 incarce_2008 incarce_2010 incarce_2012 incarce_2014 incarce_2016 incarce_2018;
run;
...
run;
proc freq data=six;
tables loveaff loveaff_2012 loveaff_2014 loveaff_2016 loveaff_2018;
run;
...
run;
proc corr data=six alphha; 
var dcourte_2012 drespec_2012 dservic_2012 dnsmart_2012 dafraid_2012 ddishon_2012 dbetter_2012 dinsult_2012 dthreat_2012; 
run;
proc corr data=six alphha; 
var dcourte_2014 drespec_2014 dservic_2014 dnsmart_2014 dafraid_2014 ddishon_2014 dbetter_2014 dinsult_2014 dthreat_2014; 
run;
proc corr data=six alphha; 
var dcourte_2016 drespec_2016 dservic_2016 dnsmart_2016 dafraid_2016 ddishon_2016 dbetter_2016 dinsult_2016 dthreat_2016; 
run;
proc print data=six (obs=75);
...
proc freq data= eight;
	tables mmental mmental_2012 mmental_2014 mmental_2016 mmental_2018;
run;
...
*checking that frequency of combined variable matched individual years;
proc freq data= nine;
	tables msubstu msubstu_2012 msubstu_2014 msubstu_2016 msubstu_2018;
run;
...
*checking that frequency of combined variable matched individual years;
proc freq data=ten;
	tables mphysab mphysab_2012 mphysab_2014 mphysab_2016 mphysab_2018;
run;
...
tables mloveaf mloveaf_2012 mloveaf_2014 mloveaf_2016 mloveaf_2018;
run;
...
tables foodins foodins_2012 foodins_2014 foodins_2016 foodins_2018;
run;
...
tables tanfas tanfas_1994 tanfas_1996 tanfas_1998 tanfas_2000;
run;
...
tables foodins tanfas foodstp bneedin;
run;
proc print data=fifteen (obs=75);
var foodins tanfas foodstp bneedin;
run;

proc corr data=fifteen alphha; 
var foodins tanfas foodstp; 
run;
...
;
run;
proc corr data=nineteen alphha; 
var rullaws_1994 crimevi_1994 abandon_1994 policep_1994 pubtran_1994 supervi_1994 dontcar_1994 notjobs_1994; 
run;
proc corr data=nineteen alphha; 
var rullaws_1996 crimevi_1996 abandon_1996 policep_1996 pubtran_1996 supervi_1996 dontcar_1996 notjobs_1996; 
run;
proc corr data=nineteen alphha; 
var rullaws_1998 crimevi_1998 abandon_1998 policep_1998 pubtran_1998 supervi_1998 dontcar_1998 notjobs_1998; 
run;
proc corr data=nineteen alphha; 
var rullaws_2000 crimevi_2000 abandon_2000 policep_2000 pubtran_2000 supervi_2000 dontcar_2000 notjobs_2000; 
run;
proc corr data=nineteen alphha; 
var rullaws_2002 crimevi_2002 abandon_2002 policep_2002 pubtran_2002 supervi_2002 dontcar_2002 notjobs_2002; 
run;
proc corr data=nineteen alphha; 
var rullaws_2004 crimevi_2004 abandon_2004 policep_2004 pubtran_2004 supervi_2004 dontcar_2004 notjobs_2004; 
run;
proc corr data=nineteen alphha; 
var rullaws_2006 crimevi_2006 abandon_2006 policep_2006 pubtran_2006 supervi_2006 dontcar_2006 notjobs_2006; 
run;
proc corr data=nineteen alphha; 
var rullaws_2008 crimevi_2008 abandon_2008 policep_2008 pubtran_2008 supervi_2008 dontcar_2008 notjobs_2008; 
run;
proc corr data=nineteen alphha; 
var rullaws_2010 crimevi_2010 abandon_2010 policep_2010 pubtran_2010 supervi_2010 dontcar_2010 notjobs_2010; 
run;
proc corr data=nineteen alphha; 
var rullaws_2012 crimevi_2012 abandon_2012 policep_2012 pubtran_2012 supervi_2012 dontcar_2012 notjobs_2012; 
run;
proc corr data=nineteen alphha; 
var rullaws_2014 crimevi_2014 abandon_2014 policep_2014 pubtran_2014 supervi_2014 dontcar_2014 notjobs_2014; 
run;
proc corr data=nineteen alphha; 
var rullaws_2016 crimevi_2016 abandon_2016 policep_2016 pubtran_2016 supervi_2016 dontcar_2016 notjobs_2016; 
run;
proc corr data=nineteen alphha; 
var rullaws_2018 crimevi_2018 abandon_2018 policep_2018 pubtran_2018 supervi_2018 dontcar_2018 notjobs_2018; 
run;
...
tables depress_1994 depress_1996 depress_1998 depress_2000 depress_2002 depress_2004 depress_2006 depress_2008 depress_2010
depress_2012 depress_2014 depress_2016 depress_2018;
run; 
*cronbach's alpha for depression measures;
proc corr data=twentytwo alpha nomiss;
var depress_1_1994 depress_2_1994 depress_3_1994 depress_4_1994 depress_5_1994 depress_6_1994 depress_7_1994;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_1996 depress_2_1996 depress_3_1996 depress_4_1996 depress_5_1996 depress_6_1996 depress_7_1996;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_1998 depress_2_1998 depress_3_1998 depress_4_1998 depress_5_1998 depress_6_1998 depress_7_1998;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2000 depress_2_2000 depress_3_2000 depress_4_2000 depress_5_2000 depress_6_2000 depress_7_2000;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2002 depress_2_2002 depress_3_2002 depress_4_2002 depress_5_2002 depress_6_2002 depress_7_2002;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2004 depress_2_2004 depress_3_2004 depress_4_2004 depress_5_2004 depress_6_2004 depress_7_2004;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2006 depress_2_2006 depress_3_2006 depress_4_2006 depress_5_2006 depress_6_2006 depress_7_2006;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2008 depress_2_2008 depress_3_2008 depress_4_2008 depress_5_2008 depress_6_2008 depress_7_2008;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2010 depress_2_2010 depress_3_2010 depress_4_2010 depress_5_2010 depress_6_2010 depress_7r_2010 depress_8_2010 depress_9_2010 depress_10_2010 depress_11_2010;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2012 depress_2_2012 depress_3_2012 depress_4_2012 depress_5_2012 depress_6_2012 depress_7r_2012 depress_8_2012 depress_9_2012 depress_10_2012 depress_11_2012;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2014 depress_2_2014 depress_3_2014 depress_4_2014 depress_5_2014 depress_6_2014 depress_7r_2014 depress_8_2014 depress_9_2014 depress_10_2014 depress_11_2014;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2016 depress_2_2016 depress_3_2016 depress_4_2016 depress_5_2016 depress_6_2016 depress_7r_2016 depress_8_2016 depress_9_2016 depress_10_2016 depress_11_2016;
run;
proc corr data=twentytwo alpha nomiss;
var depress_1_2018 depress_2_2018 depress_3_2018 depress_4_2018 depress_5_2018 depress_6_2018 depress_7r_2018 depress_8_2018 depress_9_2018 depress_10_2018 depress_11_2018;
run;
...
accinju_2014 accinju_2016;
run;
proc univariate data=twentythree;
var accinju;
run;
...
agelastvic_2006 agelastvic_2008 agelastvic_2010 agelastvic_2012 agelastvic_2014 agelastvic_2016 agelastvic_2018;
run;
proc univariate data=twentyfour;
var evrvicr;
run;
...
tables drinkdy_1994 drinkdy_1996 drinkdy_1998 drinkdy_2000 drinkdy_2002 drinkdy_2004 drinkdy_2006 drinkdy_2008 drinkdy_2010
drinkdy_2012 drinkdy_2014 drinkdy_2016 drinkdy_2018;
run;
...
weight w_0;
tables black white hisp asian asian_nhpi othrace/missing;
run; 
...
data thirtythree;
set thirtytwo;
/*if discrim=1 then*/ discrim_reason=0;
array discrim_r {4} dreason_2012 dreason_2014 dreason_2016 dreason_2018;
do i=1 to 4;
if discrim_r(i)in (1,3,7) then discrim_reason = 1;
end;
discrim_reason_sum = sum(dreason_2012, dreason_2014, dreason_2016, dreason_2018);
if discrim_reason_sum=. then discrim_reason=.;
run;
proc freq data=thirtythree;
tables discrim*discrim_reason discrim_reason discrim_reason_sum dreason_2012 dreason_2014 dreason_2016 dreason_2018/missing;
run;
proc print data=thirtythree(obs=50);
var discrim discrim_reason discrim_reason_sum dreason_2012 dreason_2014 dreason_2016 dreason_2018;
run;
...
sensitivityNOTRES;
run;
proc sort data=finalvar_01302023;
by childid;
run;

proc import file="C:\Users\55484\OneDrive - ICF\Documents\ADIA\Data\AdjustedIncomeData_9Jan2023.csv"
    out=adjinco
    dbms=csv;
run;
...
by childid;
run;
data nls.finalvar_01302023;
   MERGE adjinco_f3 finalvar_01302023;
   BY childid;
  PROC PRINT DATA=nls.finalvar_01302023 (obs=50); 
  RUN;
proc contents data=nls.finalvar_01302023;
run;

  proc export data=nls.finalvar_01302023
    outfile='C:/Users/55484/OneDrive - ICF/Documents/ADIA/Data/finalvar_01.30.2023.csv'
    dbms=csv
	replace;
	putnames=yes;
run;
...
/*ods rtf file= 'C:\Users\55484\OneDrive - ICF\Documents\ADIA\NLS Data Analysis\finalvar_01.05.2023.rtf' style=minimal;*/
proc freq data=nls.finalvar_01302023;
weight w_0;
tables ygender_xrnd
biryear_xrnd
black 
...
proc univariate data=nls.finalvar_01302023;
var drinkdy depress
preshlth
anxiety
mhhinco;
...
proc corr data=nls.finalvar_01302023 alpha nomiss;
var var1 var2 var3;
run;
