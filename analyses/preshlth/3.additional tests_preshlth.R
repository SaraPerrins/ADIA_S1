...
#classical tree for present health

dat <-
  dat %>%
  mutate(ace_ocs =
           case_when(
             (subsuse==1) & !(bneedin ==1 | commstr==1) ~ "ACE"
             , (subsuse==1) &  (bneedin ==1 | commstr==1) ~ "ACE + OCS"
             , !(subsuse==1) &  (bneedin ==1 | commstr==1) ~ "OCS"
             ,! (subsuse==1) & !(bneedin ==1 | commstr==1) ~ "None"
           )
         , ace_ocs = factor(ace_ocs)
         , ace_ocs = relevel(ace_ocs, ref = "None")
  )
...
#========================================================================
# repeat process for causal present health tree
#========================================================================
#========================================================================
