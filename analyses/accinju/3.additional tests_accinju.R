...
dat <-
  ...
  mutate(ace_ocs =
           case_when(
             anyACE_T == 1 & !(ecstand == 1 | mphysab == 1 | mmental == 1) ~ "ACE"
             , anyACE_T == 1 &  (ecstand == 1 | mphysab == 1 | mmental == 1) ~ "ACE + OCS"
             , anyACE_T == 0 &  (ecstand == 1 | mphysab == 1 | mmental == 1) ~ "OCS"
             , anyACE_T == 0 & !(ecstand == 1 | mphysab == 1 | mmental == 1) ~ "None"
           )
